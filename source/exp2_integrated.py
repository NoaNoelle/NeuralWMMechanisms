...
Integrates activity-silent storage as in the Pals model 
(Pals et al., 2020) and the extention thereof (Knol, 2020; Wijs, 2020) for 
unattended information and activity-based storage as in the CSR model for 
attended information in WM. Additionally, a clearance mechanism on the basis
of the GR mechanism is utilized to delete information no longer required for
task performance. 
"""
